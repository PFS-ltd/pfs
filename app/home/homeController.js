(function () {
    var homeController = app.controller('HomeController',
        function ($scope, Auth, ngToast, $state, currentAuth, $transitions, $location, $http) {
...
//                console.log($scope.currencyRates);
    ...
    homeController.$inject = ['$scope', 'Auth', 'ngToast', '$state', 'currentAuth', '$transitions', '$location', '$http']
})();
